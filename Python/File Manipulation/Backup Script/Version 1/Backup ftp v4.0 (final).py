...
Destination = os.environ["Destination"] # Location on your computer to download files
#############################################
...
if linux == linux or darmin == darmin or os2 == os2: # Makes sure that this scropt is running on one of these OS's 
  ...
  call(["7z", "a", "-t7z", directoryName + ".7z", Destination + "/" + directoryName, "-mx9", "-mmt", "-ms", "-p" + Archive_password])
